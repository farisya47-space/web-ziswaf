          ...
          <table class="w-full text-left text-sm whitespace-nowrap">
            ...
            <tbody class="divide-y divide-border">
              <tr v-for="trx in paginatedTransactions" :key="trx.id" class="hover:bg-muted/30 transition-colors">
                ...
                <td class="p-4 font-semibold text-success">Rp {{ trx.amount.toLocaleString() }}</td>
...
const transactions = ref([
  { id: 1, number: 'IN015123456', date: '15 Mar 2026', category: 'Zakat Fitrah', amount: 2500000, description: 'Zakat fitrah dari muzakki' },
  { id: 2, number: 'IN020876543', date: '20 Mar 2026', category: 'Infaq', amount: 5000000, description: 'Infaq dari donatur' },
  { id: 3, number: 'IN022987612', date: '22 Mar 2026', category: 'Sedekah', amount: 1000000, description: 'Sedekah untuk yatim piatu' },
  { id: 4, number: 'IN025432187', date: '25 Mar 2026', category: 'Wakaf', amount: 10000000, description: 'Wakaf tanah untuk masjid' }
])
